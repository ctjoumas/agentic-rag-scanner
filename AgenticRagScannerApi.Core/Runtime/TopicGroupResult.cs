...
public sealed class TopicGroupResult
{
    ...
    /// <summary>Vetted items surfaced for this group (empty for the Phase 1 stub). Each carried item
    /// carries its own per-document Company View (<see cref="ResultItem.CompanyView"/>).</summary>
