...
/// <summary>
/// System-prompt builder for the Enrichment agent. Placeholder for Epic 2 (the agent is stubbed and
...
public static class EnrichmentPrompt
{
    ...
    public static string BuildSystemPrompt() =>
        "TODO (Epic 7): instruct the model to produce a concise plain-English 'what it does' summary " +
        "and enriched metadata for an already-vetted item (relevance is decided; do not re-judge it).";
}
